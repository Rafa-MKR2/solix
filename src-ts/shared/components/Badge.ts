...
export function createStatusBadge(status: string, options: Partial<BadgeOptions> = {}): HTMLElement {
...
export function createCountBadge(count: number, options: Partial<BadgeOptions> = {}): HTMLElement {
