...
fn get_command_database(
    ...
    db.insert(
        "apt",
        (
            "Gerenciador de pacotes APT (Debian/Ubuntu). Instala, remove e atualiza programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "apt-get",
        (
            "Gerenciador de pacotes APT (versão clássica). Baixa e instala programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "dpkg",
        (
            "Instalador de pacotes .deb. Instala programas manualmente.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "pacman",
        (
            "Gerenciador de pacotes do Arch Linux. Instala e gerencia programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "yay",
        (
            "Ajudante AUR para Arch. Instala programas da comunidade.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "paru",
        (
            "Ajudante AUR rápido para Arch. Instala programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "dnf",
        (
            "Gerenciador de pacotes DNF (Fedora). Instala e gerencia programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "yum",
        (
            "Gerenciador de pacotes YUM (CentOS/RHEL antigo). Instala programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "zypper",
        (
            "Gerenciador de pacotes do openSUSE. Instala e gerencia programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "snap",
        (
            "Gerencia pacotes Snap (universal). Instala programas em sandbox.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "flatpak",
        (
            "Gerencia pacotes Flatpak (universal). Instala programas em sandbox.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "pip",
        (
            "Instalador de pacotes Python. Baixa e instala bibliotecas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "npm",
        (
            "Gerenciador de pacotes Node.js. Instala bibliotecas JS.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "cargo",
        (
            "Gerenciador de pacotes Rust. Compila e instala programas.",
            "install",
            "Pacotes",
        ),
    );
    db.insert(
        "gem",
        (
            "Gerenciador de pacotes Ruby. Instala bibliotecas.",
            "install",
            "Pacotes",
        ),
    );
    ...
    db.insert(
        "sudo",
        (
            "Executa comandos como administrador (root). Requer sua senha.",
            "sudo",
            "Sistema",
        ),
    );
    db.insert(
        "pkexec",
        (
            "Executa comandos com privilégios admin (alt. ao sudo).",
            "sudo",
            "Sistema",
        ),
    );
    db.insert(
        "doas",
        (
            "Executa comandos como admin (alternativa leve).",
            "sudo",
            "Sistema",
        ),
    );
    db.insert(
        "systemctl",
        (
            "Gerencia serviços do sistema (iniciar, parar, habilitar).",
            "system",
            "Sistema",
        ),
    );
    ...
    db.insert(
        "poweroff",
        ("Desliga o computador imediatamente.", "system", "Sistema"),
    );
    ...
    db.insert(
        "rm",
        ("Remove arquivos. CUIDADO com rm -rf!", "danger", "Arquivos"),
    );
    db.insert(
        "mkdir",
        ("Cria uma nova pasta (diretório).", "safe", "Arquivos"),
    );
    db.insert("rmdir", ("Remove uma pasta vazia.", "safe", "Arquivos"));
    db.insert(
        "touch",
        ("Cria arquivo vazio ou atualiza data.", "safe", "Arquivos"),
    );
    db.insert(
        "cat",
        (
            "Mostra conteúdo de arquivo ou junta arquivos.",
            "safe",
            "Arquivos",
        ),
    );
    db.insert(
        "chmod",
        ("Altera permissões de arquivos.", "system", "Arquivos"),
    );
    db.insert(
        "chown",
        ("Altera o dono de arquivos.", "system", "Arquivos"),
    );
    db.insert(
        "ln",
        ("Cria links (atalhos) para arquivos.", "safe", "Arquivos"),
    );
    db.insert("find", ("Procura arquivos e pastas.", "safe", "Arquivos"));
    db.insert(
        "grep",
        ("Procura textos dentro de arquivos.", "safe", "Arquivos"),
    );
    db.insert(
        "sed",
        ("Edita textos (substitui palavras).", "safe", "Arquivos"),
    );
    db.insert("awk", ("Processa texto colunas.", "safe", "Arquivos"));
    db.insert(
        "tee",
        (
            "Salva saída em arquivo e mostra na tela.",
            "safe",
            "Arquivos",
        ),
    );
    db.insert(
        "rsync",
        (
            "Sincroniza arquivos entre pastas/computadores.",
            "safe",
            "Arquivos",
        ),
    );
    ...
    db.insert(
        "curl",
        (
            "Transfere dados da internet. Pode baixar arquivos.",
            "download",
            "Rede",
        ),
    );
    db.insert(
        "ssh",
        (
            "Conecta remotamente a outro computador.",
            "download",
            "Rede",
        ),
    );
    db.insert(
        "scp",
        (
            "Copia arquivos entre computadores pela rede.",
            "download",
            "Rede",
        ),
    );
    db.insert(
        "ping",
        (
            "Testa se um computador está acessível na rede.",
            "safe",
            "Rede",
        ),
    );
    db.insert(
        "ip",
        ("Mostra/configura endereços de rede.", "system", "Rede"),
    );
    ...
    db.insert(
        "git",
        (
            "Controle de versão. Baixa e gerencia projetos.",
            "download",
            "Desenvolvimento",
        ),
    );
    db.insert(
        "make",
        (
            "Compila programas a partir do código.",
            "install",
            "Desenvolvimento",
        ),
    );
    db.insert(
        "gcc",
        ("Compilador de C/C++.", "install", "Desenvolvimento"),
    );
    db.insert(
        "python",
        ("Interpretador Python.", "safe", "Desenvolvimento"),
    );
    db.insert(
        "python3",
        ("Interpretador Python 3.", "safe", "Desenvolvimento"),
    );
    db.insert(
        "node",
        ("Interpretador JavaScript.", "safe", "Desenvolvimento"),
    );
    db.insert(
        "docker",
        ("Gerencia contêineres.", "install", "Desenvolvimento"),
    );
    db.insert(
        "cargo",
        ("Gerenciador de pacotes Rust.", "install", "Desenvolvimento"),
    );
    ...
    db.insert(
        "tar",
        (
            "Empacota/extrai arquivos .tar, .tar.gz.",
            "safe",
            "Compactação",
        ),
    );
    db.insert(
        "gzip",
        ("Comprime/descomprime arquivos .gz.", "safe", "Compactação"),
    );
    db.insert(
        "gunzip",
        ("Descomprime arquivos .gz.", "safe", "Compactação"),
    );
    ...
    db.insert(
        "export",
        ("Define variável de ambiente.", "safe", "Terminal"),
    );
    db.insert("alias", ("Cria atalho para comando.", "safe", "Terminal"));
    db.insert(
        "source",
        ("Executa script no terminal atual.", "safe", "Terminal"),
    );
    db.insert(
        "read",
        ("Lê entrada do usuário pelo teclado.", "safe", "Terminal"),
    );
    db.insert(
        "sleep",
        ("Pausa o script por alguns segundos.", "safe", "Terminal"),
    );
    ...
    db.insert(
        "pwd",
        ("Mostra caminho da pasta atual.", "safe", "Terminal"),
    );
    ...
    db.insert(
        "dd",
        (
            "Copia dados em baixo nível. Pode danificar discos!",
            "danger",
            "Sistema",
        ),
    );
    db.insert(
        "mkfs",
        ("Formata disco/partição. APAGA TUDO!", "danger", "Sistema"),
    );
    db.insert(
        "fdisk",
        (
            "Gerencia partições. Pode danificar dados!",
            "danger",
            "Sistema",
        ),
    );
    ...
    db.insert(
        "ps",
        ("Mostra processos em execução.", "safe", "Monitoramento"),
    );
    db.insert(
        "top",
        ("Processos em tempo real por CPU.", "safe", "Monitoramento"),
    );
    db.insert(
        "df",
        ("Mostra espaço livre nos discos.", "safe", "Monitoramento"),
    );
    db.insert(
        "du",
        (
            "Mostra tamanho de pastas/arquivos.",
            "safe",
            "Monitoramento",
        ),
    );
    db.insert(
        "free",
        ("Mostra uso de RAM e swap.", "safe", "Monitoramento"),
    );
    db.insert(
        "uname",
        ("Mostra info do sistema (kernel).", "safe", "Monitoramento"),
    );
    db.insert(
        "lscpu",
        ("Info detalhada do processador.", "safe", "Monitoramento"),
    );
    db.insert(
        "lsblk",
        ("Lista discos e partições.", "safe", "Monitoramento"),
    );
    db.insert(
        "lspci",
        ("Mostra dispositivos conectados.", "safe", "Monitoramento"),
    );
    db.insert(
        "lsusb",
        ("Mostra dispositivos USB.", "safe", "Monitoramento"),
    );
...
fn is_download_pipe(content: &str) -> bool {
    ...
    if lower.contains("curl") || lower.contains("wget") {
        ...
        if lower.contains("bash <(curl")
            || lower.contains("sh <(curl")
            || lower.contains("bash <(wget")
        {
            return true;
        }
    }
...
fn is_dangerous_rm(content: &str) -> bool {
    let lower = content.to_lowercase();
    if lower.starts_with("rm") && (lower.contains(" /") || lower.contains(" /*")) {
...
fn analyze_python_line(line: &str, line_no: u32) -> Option<ScriptCommand> {
    ...
    let cmd =
        |command: &str, desc: &str, risk: &str, cat: &str, review: bool| -> Option<ScriptCommand> {
            Some(ScriptCommand {
                line: line_no,
    ...
    if trimmed.contains("os.system(") || trimmed.contains("os.popen(") {
        return cmd(
            "os.system",
            "Executa comando no terminal. PERIGOSO se for de fonte externa!",
            "danger",
            "Sistema",
            true,
        );
    ...
    if trimmed.contains("subprocess.")
        && (trimmed.contains(".call")
            ...
            || trimmed.contains(".check_output"))
    {
        return cmd(
            "subprocess",
            "Executa comandos no terminal pelo Python.",
            "sudo",
            "Sistema",
            true,
        );
    ...
    if trimmed.contains("eval(") && !trimmed.starts_with('#') {
        return cmd(
            "eval",
            "⚠️ PERIGOSO! Executa código dinâmico. Risco de segurança!",
            "danger",
            "Python",
            true,
        );
    ...
    if trimmed.contains("exec(") && !trimmed.starts_with('#') {
        return cmd(
            "exec",
            "⚠️ PERIGOSO! Executa código arbitrário. Risco de segurança!",
            "danger",
            "Python",
            true,
        );
    ...
    if trimmed.contains("open(") && !trimmed.starts_with('#') {
        return cmd(
            "open",
            "Abre arquivos para leitura/escrita.",
            "system",
            "Arquivos",
            false,
        );
    ...
    if trimmed.contains("requests.")
        || trimmed.contains("urlopen")
        || trimmed.contains("urllib.request")
    {
        return cmd(
            "requests",
            "Faz requisições HTTP. Baixa/envia dados pela internet.",
            "download",
            "Rede",
            false,
        );
    ...
    if trimmed.starts_with("import ") || trimmed.starts_with("from ") {
        let import_name = if let Some(stripped) = trimmed.strip_prefix("import ") {
            stripped
        } else {
            &trimmed[5..]
        };
    ...
    if matches!(
        ...
        return cmd(
            kw,
            "Palavra-chave de controle do Python.",
            "safe",
            "Python",
            false,
        );
...
fn generate_summary(
    ...
    has_download_execute: bool,
    has_dangerous: bool,
) -> String {
    if commands.is_empty() {
        return "Script vazio ou com apenas comentários.".to_string();
    }
    ...
    let install_count = commands
        .iter()
        .filter(|c| c.risk == "install" || (c.risk == "sudo" && c.category == "Pacotes"))
        .count();
    let sudo_count = commands
        .iter()
        .filter(|c| c.risk == "sudo" || c.content.contains("sudo "))
        .count();
    ...
    if install_count > 0 {
        parts.push(format!("instala {} pacote(s)", install_count));
    }
    if download_count > 0 {
        parts.push(format!("baixa {} arquivo(s) da internet", download_count));
    }
    if sudo_count > 0 {
        parts.push(format!("requer senha {} vez(es)", sudo_count));
    }
    if has_download_execute {
        parts.push("⚠️ baixa e executa código da internet".to_string());
    }
    if has_dangerous {
...
fn analyze_shell_script(content: &str) -> (Vec<ScriptCommand>, bool, bool, bool, bool) {
    ...
    for (i, line) in content.lines().enumerate() {
        ...
        if cmd.is_empty() || line.trim().ends_with('\\') {
            continue;
        }
        ...
        if is_download_pipe(t) {
            ...
            commands.push(ScriptCommand {
                ...
                content: t.to_string(),
                command: cmd.to_string(),
                description: "⚠️ Baixa e EXECUTA código da internet!".to_string(),
        ...
        if is_dangerous_rm(t) {
            ...
            commands.push(ScriptCommand {
                ...
                content: t.to_string(),
                command: cmd.to_string(),
                description: "⚠️ Remove arquivos do sistema!".to_string(),
                risk: "danger".to_string(),
        ...
        let has_sudo_prefix =
            t.starts_with("sudo ") || t.starts_with("pkexec ") || t.starts_with("doas ");
        if has_sudo_prefix {
            has_sudo = true;
        }
        if let Some((desc, risk, category)) = db.get(cmd_lower.as_str()) {
            ...
            commands.push(ScriptCommand {
                ...
                command: cmd.to_string(),
                description: desc.to_string(),
                risk: erisk.to_string(),
                category: category.to_string(),
                requires_review: *risk == "danger" || has_sudo_prefix,
            });
        } else {
            commands.push(ScriptCommand {
                line: line_no,
...
pub fn analyze_script(content: &str) -> ScriptAnalysis {
            ...
            for (i, line) in content.lines().enumerate() {
                if let Some(c) = analyze_python_line(line, (i + 1) as u32) {
                    match c.risk.as_str() {
                        "danger" => {
                            has_dangerous = true;
                            has_download_execute = has_download_execute || c.category == "Rede";
                        }
    ...
    let risk_level = if has_dangerous {
        "danger"
    } else if has_download_execute {
        "warning"
    } else if has_install || has_sudo {
        "medium"
    } else {
        "safe"
    };
...
mod tests {
    ...
    fn test_detect_type() {
        ...
        assert_eq!(
            detect_script_type("#!/usr/bin/python3\n"),
            ScriptType::Python
        );
